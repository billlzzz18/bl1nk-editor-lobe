...
// Base metadata for the application. This object is exported below to provide
// static metadata in addition to dynamic trace data from Sentry. Note that
// `generateMetadata` will merge this metadata with trace context【207018396183717†L149-L160】.
...
// Export the metadata constant so Next.js can statically generate meta tags.
export const metadata = baseMetadata

// Generate dynamic metadata for distributed tracing. When Sentry is enabled,
// Next.js will call this function and merge the returned object with the
// existing metadata. See Sentry docs for details【207018396183717†L149-L160】.
    ...
    <html lang="th">
      <body>
        <Providers>
          ...
          {/* Collect web vital metrics and send to analytics endpoint */}
          <WebVitals />
        </Providers>
      </body>
    </html>
